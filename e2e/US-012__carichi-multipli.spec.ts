...
test('multi-ISIN: due ISIN diversi → due righe distinte nella tabella aggregata', async ({
  ...
  await archivio.aggiungiPosizione(portfolioId, 'IE00B3RBWM25', '2026-03-20', 115.5, 20);
...
test('coerenza reload: riga aggregata invariata dopo reload pagina', async ({ page, archivio }) => {
  ...
  await archivio.aggiungiPosizione(portfolioId, 'IE00B4L5Y983', '2026-03-15', 89.0, 40);
  await archivio.aggiungiPosizione(portfolioId, 'IE00B4L5Y983', '2026-04-10', 91.0, 60);
